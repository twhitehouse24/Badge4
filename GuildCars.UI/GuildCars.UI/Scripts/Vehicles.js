    ...
    $.ajax({
        ...
        success: function (searchArray) {
            ...
            $.each(searchArray, function (index, carSearch) {
                ...
                searchInfo += '<table border="0" style="width: 90%"><tr><td style="padding:  10px 10px 5px 10px; width: 15%">'
                searchInfo += '<center><b>' + carSearch.CarId + ' ' + carSearch.CarYr + ' ' + carSearch.Make + ' ' + carSearch.Model
                ...
                searchInfo += '<a href="EditVehicle/' + carSearch.CarId + '"><button type="button" >Edit</button></a>'
